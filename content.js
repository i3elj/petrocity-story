let Content = [
	...
	atracoes: {
	    ...
	    content: [
		{
		    ...
		    content: "Lançamento do carnaval de Petrolina — Foto: Ayrton Latapiat / Ascom PMP A prefeitura de Petrolina, no Sertão de Pernambuco, lançou a programação oficial do Carnaval 2023, que será realizado entre os dias 18 e 21 de fevereiro. As atrações foram divulgadas na noite da quarta-feira (8), em um evento às margens do rio São Francisco. A festa, que volta a ser realizada após dois anos, por causa da pandemia da Covid-19, vai ter como tema: \"Vamos desfilar a vida, carnavalizar!\" O Carnaval de Petrolina vai contar com mais de 60 atrações entre artistas e blocos. O evento será dividido em três polos que já são tradicionais no município: Orla, 21 de Setembro e Multicultural. Segundo a prefeitura, além de homenagear Domingos Manoel de Souza, que faz parte da história do carnaval da cidade com o bloco ‘ Os que ficaram’, a festa vai abrir um conjunto de ações para lembrar o centenário de Ana das Carrancas. Yolande Caffé e Luciano dos Santos foram anunciados pelo prefeito Simão Durando como reis do Carnaval 2023."
		},
		{
		    title: "São João de Petrolina 2023",
		    content: "Alok, Taty Girl, João Gomes, Mari Fernandez, Léo Santana e outros artistas estão na programação do São João de Petrolina 2023 Crédito: Divulgação Os festejos juninos nas cidades do Nordeste já estão prontos para iniciar. Em Pernambuco, a programação do São João 2023 irá ocorrer nos municípios de Caruaru e Petrolina. Batizada de “maior e melhor” São João, o evento em Caruaru teve início no dia 28 de abril e seguirá com programação de shows e apresentações especiais até o dia 1º de julho, totalizando 65 dias de festa na cidade."
		}
	    ]
	},
	obituario: {
	    ...
	    content: [
		{
		    title: "Morre em Petrolina o cantor Pedro Duarte, da banda Linguagem Musical",
		    content: "Morreu nesta sexta-feira (13), em Petrolin, o cantor João Pedro da Silva, 50 anos, popularmente conhecido como Pedro Duarte, da banda Linguagem Musical. Segundo informações, o artista passou mal durante a manhã, chegou a dar entrada na UPA, mas não resistiu. A causa da morte foi infarto. O cantor tinha show marcado para esta sexta-feira, no Clube da Aesa, em Petrolina. Pedro Duarte tinha 58 anos e deixa quatro filhos. Ainda não há informações sobre local e horário do velório."
		}
	    ]
	},
	inauguracoes: {
	    ...
	    content: [
		{
		    title: "Nova sede da Secretaria de Agricultura é inaugurada em Petrolina e retoma atendimento ao público",
		    content: "Mais um momento marcante para a gestão municipal: a mudança da sede da Secretaria de Agricultura para um local ampliado na região central de Petrolina, na Rua Santa Cecília, 35, Centro. Na manhã desta segunda-feira (28), mais de 200 pessoas, entre lideranças e representantes das áreas irrigada, ribeirinha e sequeiro, compareceram ao café da manhã em virtude, também, de reunião para discutir e ressaltar ações de fortalecimento para a zona rural do município. Na ocasião, a secretaria foi reaberta para atendimento ao público, já que nas duas últimas semanas as equipes estavam no processo de mudança. Foi um momento de ouvir as demandas e planejar as ações futuras para o homem e a mulher do campo. O secretário de Agricultura, Pedro Brandão, ainda apresentou a estrutura do local ao prefeito Simão Durando e autoridades que estiveram presentes, a exemplo do ex-senador Fernando Bezerra."
		},
		{
		    title: "Prefeito Simão Durando inaugura cinco vias pavimentados em Petrolina",
	...
	inauguracoes: {
		...
		{
		    title: "Escolinha de trânsito pública do Brasil",
		    content: "No Parque Josepha Coelho foi montado um circuito prático composto por ruas, semáforos, placas de sinalização (horizontal e vertical), faixas de pedestres e ciclovias, entre outros. A partir de agora, as crianças vivenciarão situações de mobilidade coletiva e individual, a bordo de minicarros, bicicletas ou a pé, aprendendo a conviver e a respeitar as regras de trânsito. A primeira turminha, com cerca de 20 estudantes, já iniciou as aulas. Em tom lúdico, mas com uma mensagem muito importante, os pequenos motoristas precisaram ficar atentos às cores dos semáforos para seguir em frente, parar ou ter atenção, além de sempre respeitar a faixa de pedestres. De acordo com o prefeito Simão Durando a ideia principal é formar uma nova geração de adultos mais conscientes no trânsito. “Mais um orgulho para Petrolina! Este projeto tem por objetivo incentivar nossas crianças a conhecerem a realidade do trânsito, promovendo atitudes corretas para evitar acidentes. Sem dúvidas investir em educação é o melhor caminho para formar os petrolinenses do futuro com consciência e responsabilidade”, concluiu. ‘Turminha do Trânsito’, esse é o nome da primeira escolinha permanente de educação de trânsito 100% pública do Brasil implantada pela Prefeitura de Petrolina. O projeto, coordenado pela Autarquia Municipal de Mobilidade de Petrolina (Ammpla) foi lançado nesta quarta-feira (28) pelo prefeito Simão Durando."
		},
		{
		    title: "6ª Escola de Tempo Integral",
	...
	atracoes: {
	    ...
	    content: [
		{
		    title: "Prefeito de Petrolina cancela festas de réveillon e carnaval.",
		    content: "Pelo segundo ano consecutivo, a prefeitura de Petrolina, no Sertão de Pernambuco, não vai realizar festas de réveillon e carnaval. O anúncio foi feito pelo prefeito Miguel Coelho (DEM), durante entrevista ao programa Nossa Voz, Rádio Grande Rio FM, na manhã desta terça-feira (30). O crescimento do número de casos e surgimento de novas variantes do coronavírus motivaram o cancelamento. De acordo com o prefeito, já havia um planejamento para a preparação da festa de fim de ano. A decisão, porém, foi suspender os shows e realizar apenas a queima de fogos de artifício na Orla de Petrolina. O Carnaval também será cancelado, permitindo-se somente eventos privados com limite de público e protocolos de higiene conforme os critérios determinados pela Secretaria de Saúde do Estado."
		},
		{
		    title: "Rally dos Sertões 2021.",
		    content: "O Sertões, maior rally das Américas, anunciou neste domingo (30) as novidades para a edição 2021 do evento. Uma das cidades incluídas para a maior competição do off road do Brasil será em Petrolina. Essa é a 29º edição do evento, que seguirá um protocolo de segurança devido à pandemia do coronavírus. O Rally dos Sertões será disputado do dia 13 a 22 de agosto, com largada na cidade de Timbaú do Sol, Rio Grande do Norte, e com passagem por Petrolina nos dias 19 e 20 de agosto (sexta e sétima etapa da prova). O roteiro com cerca de 5.000 quilômetros será baseado no tema “Sertões 100% Sertão”, reunindo os melhores trechos especiais da região Nordeste. “O prefeito Miguel Coelho já determinou que a Prefeitura assegure o suporte necessário para que o evento seja um sucesso em Petrolina. Os secretários já foram mobilizados e nós vamos trabalhar para que tudo aconteça da melhor forma possível e dentro dos protocolos sanitários”, destacou o secretário de Desenvolvimento Econômico e Turismo, Flávio Guimarães. Flávio ressalta ainda a importância que o evento traz para o município. “Com a grande visibilidade do evento, a economia local será aquecida, uma vez que a competição reúne milhares de pessoas, fomentando a rede hoteleira, além de restaurantes, bares, e comércio em geral.”"
		},
		{
		    title: "Olhares Juninos",
		    content: "Para os nordestinos o mês de junho sempre foi aguardado com expectativa. Isso porque, tradicionalmente, nesse período do ano, é celebrado uma das mais tradicionais festas do Nordeste, o São João. Como forma de manter acesa a chama da tradição e fomentar a arte e a cultura do povo de Petrolina, mesmo diante da pandemia do Coronavírus, a Prefeitura, através da parceria entre a Secretaria Executiva de Cultura e o Transforma Petrolina, abriu na noite desta segunda-feira (21), no Parque Municipal Josepha Coelho, a exposição ‘Olhares Juninos’. O evento, que contou com a presença do prefeito Miguel Coelho, reúne imagens dos fotógrafos Jonas Santos, Sérgio de Sá, Chico Egídio, Lizandra Martins, Lissandro Carvalho e Cristiano Almeida. As fotografias mostram as vivências e manifestações populares de Petrolina, a exemplo das quadrilhas, Missa do Vaqueiro, Jecana do Capim, e o São João do Parque Ana das Carrancas."
		},
		{
		    title: "Exposição fotográfica em homenagem às festividades juninas",
		    content: "Continuando suas ações que buscam dialogar e contribuir para a cultura popular mesmo diante do difícil período da pandemia, a Prefeitura de Petrolina, através da parceria entre a  Secretaria Executiva de Cultura e o Transforma Petrolina, promove, a partir desta segunda-feira (21), a exposição fotográfica “Olhares Juninos”. A exposição acontecerá no Transforma Petrolina, que fica dentro do Parque Municipal Josepha Coelho, até o dia 30 de junho, e logo após estará itinerante pela cidade. A coletiva fotográfica tem a intenção de lançar um olhar poético das nossas vivências culturais do mês de junho. O mês em que o coração do nordestino bate mais que zabumba em terreiro e é tomado pela alegria das fogueiras, das comidas típicas, das danças e folguedos. Os fotógrafos convidados para a exposição são: Jonas Santos, Sérgio de Sá, Chico Egídio, Lizandra Martins, Lissandro Carvalho e Cristiano Almeida."
		}
	    ]
	},
	obituario: {
	...
	obituario: {
		...
		{
		    title: "Irmão do deputado federal Gonzaga Patriota é assassinado em Petrolina",
	...
	atracoes: {
	    ...
	    content: [
		{
		    title: "Réveillon na orla de Petrolina",
		    content: "O cantor Victor Fernandes é uma das atrações da festa — Foto: Reprodução/ Vitor Fernandes A prefeitura de Petrolina, no Sertão de Pernambuco, divulgou nesta quarta-feira (18), a programação da festa de Réveillon, realizada às margens do rio São Francisco, na orla da cidade. A chegada do ano novo será celebrada com shows musicais e show pirotécnico. As atrações começam a se apresentar às 20h do dia 31 de dezembro. A abertura fica por conta do forró de Elisson Castro. Em seguida, quem se apresenta é o cantor Victor Fernandes. Já o encerramento será feito pela banda Magníficos. O Réveillon de Petrolina é organizado pela Prefeitura de Petrolina em parceria com Associação de Barraqueiros e Eventos do Vale do São Francisco (Abaev)."
		},
		{
		    title: "Carnaval Petrolina 2019",
		    content: "Faltando pouco dias para o início oficial da folia, o Carnaval de Petrolina 2019 já tem atrações confirmadas. As comemorações estão marcadas para acontecer entre os dias 22 de fevereiro e 05 de março. As apresentações estão marcadas para acontecer no Polo da Orla, local que vai receber mais atrações musicais, e Polo Multicultural. Se for como a edição passada, o horário será sempre das 19:00 às 03:00. Já no segundo polo, as orquestras realizam as apresentações entre às 18:00 e 00:00. Alguns dos nomes selecionados para agitar os foliões neste Carnaval são Devinho Novaes, Rafa Mesquita, Alan Cleber, Wallas Arrais, Luan Estilizado e Andrezza Santos. Distante cerca de 712 km do Recife, Petrolina conta anualmente com vários grandes eventos que atraem um bom número de pessoas da região e turistas, como a Vaquejada de Petrolina, o Petrolina Fashion, o Carnaval, o Festival Internacional da Sanfona, Jecana, entre outros."
		},
		{
		    title: "São João de Petrolina 2019",
		    content: "A programação do São João de Petrolina foi lançada na noite desta segunda-feira (29), pelo prefeito Miguel Coelho e o Secretário de Desenvolvimento Econômico e Turismo do município, Emício Junior. A festa principal será realizada entre os dias 14 e 23 de junho, no Pátio de Eventos Ana das Carrancas. Segundo a prefeitura, a expectativa é que este ano o São João da cidade receba 700 mil pessoas e tenha um investimento de cerca de R$ 6 milhões."
		}
	    ]
	},
	obituario: {
	...
	inauguracoes: {
		...
		{
		    title: "Jardim sensorial e pista de skate no Parque Josepha Coelho",
	...
	atracoes: {
		...
		{
		    title: "São João",
		    content: "As atrações do São João de Petrolina 2018, no Sertão de Pernambuco, conhecido também como São João do Vale mescla ritmos como o axé, arrocha, sertanejo universitário e o forró. Segundo a prefeitura, o circuito começa no dia 18 de maio‬ com o São João dos Bairros e será encerrado em 25 de junho‬, na Missa do Vaqueiro. Para este ano o evento já foi confirmado e será realizado entre os dias 15/06 até 23/06. O circuito junino ainda contará com concursos de quadrilhas e de sanfoneiros; festival de violeiros; a tradicional corrida de jegues (Jecana) e será encerrado no dia 25 de junho com a Missa do Vaqueiro, às margens do Rio São Francisco. A programação São João de Petrolina em 2018 já foi confirmada e traz atrações de todo Brasil. Alguns dos nomes em destaque são Gustavo Lima, Henrique e Juliano, Wesley Safadão, Luan Santana, Marília Mendonça, Simone e Simaria, Aviões, Maiara e Maraísa e Dorgival Dantas. A realização do evento será no Pátio de Eventos Ana das Carrancas, porém a edição de 2018 deve ser a última no local. Segundo a Prefeitura de Petrolina, a decisão foi tomada após uma recomendação Ministério Público Federal (MPF)."
		},
		{
		    title: "Carnaval de Petrolina",
		    content: "Foi divulgada a Programação do Carnaval 2018 de Petrolina. O anúncio foi realizado na noite da segunda-feira (22), ao som do maracatu da banda Matingueiros, no coreto na Praça 21 de Setembro, no Centro da cidade. Este ano, a festa terá cinco polos de animação e o Baile Municipal. Ao todo, 50 atrações devem animar as festividades de momo no município. O primeiro pólo do carnaval é a Praça 21 de setembro. O outro, será na região da Petrolina antiga, o pólo Matingueiros. Terão ainda pólos nos bairros Areia branca e na Cohab Massangano, e o polo principal na Orla de Petrolina, localizado na Porta do Rio. Cada polo terá uma programação com várias atrações. De acordo com a prefeitura, a festa terá a parceria da iniciativa privada, que vai entrar com a estrutura física do evento. A expectativa é de um público de 30 mil pessoas por noite. Foi anunciado também que a homenageada do carnaval será a jornalista e pioneira da cidade, Inah Torres. Outra novidade é o retorno do Baile Municipal e Concurso de Fantasias, que será realizado no dia 2 de fevereiro em uma casa de festas da cidade."
		},
		{
		    title: "Réveillon de Petrolina",
		    content: "Réveillon de Petrolina será na Porta do Rio. — Foto: Clédiston Anselmo/ TV Grande Rio A festa de Ano Novo em Petrolina, no Sertão de Pernambuco, contará com atrações musicais e show pirotécnico na Porta do Rio, na Orla da cidade, no dia 31 de dezembro. O réveillon começará a partir das 21h e será aberto a todos. O evento é realizado pela Associação dos Barraqueiros e Ambulantes de Eventos do Vale do São Francisco (ABAEV), em parceria com a prefeitura municipal. Vão se apresentar na festa a Super Banda, o grupo Césio Tenório & Farra dos Tops e a cantora Ana Costa. Além das atrações musicais, o público também será presenteado com dez minutos de show pirotécnico às margens do Rio São Francisco."
		}
	    ]
	},
	obituario: {
	    ...
	    content: [
		{
		    title: "Morre Maria José, a primeira mulher vereadora eleita pelo PT em Petrolina",
		    content: "A vereadora Cristina Costa (PT), postou neste domingo 23, o falecimento da primeira vereadora do Partido dos Trabalhadores com atuação em Petrolina. Confiram nota: \"É com imenso pesar que lamentamos a morte da companheira Maria José Farias, ocorrido neste domingo (23). Primeira vereadora de Petrolina pelo Partido dos Trabalhadores a ingressar na Casa Plínio Amorim. Maria José, mãe do bancário Salomão. Maria José legislou de 1989 a 1992. Nosso respeito e admiração à Maria José pela militância e luta pelo direitos de trabalhadores e trabalhadoras, por ser mulher e abraçar essa luta para conquistar e abrir espaço para outras mulheres na política. Seu legado é um exemplo para trabalhadoras, mulheres, militantes e companheiras do PT. Nossa solidariedade aos familiares e amigos\"."
		},
		{
		    title: "Morre em Petrolina o advogado, professor e compositor Anselmo Gomes",
		    content: "Morreu no início da noite desta terça-feira (04), o professor Anselmo Gomes Rodrigues. Professor Anselmo era um pesquisador da obra de Luiz Gonzaga e um defensor da cultural brasileira. O velório acontece em Petrolina, na avenida 7 de setembro, sala 4. O sepultamento será às 16 horas, quarta-feira 5. Anselmo lecionou na UPE, Campus Petrolina e na Escola Paul Harris. Exerceu a Advocacia em Petrolina e região do Vale do São Francisco. Foi um dos professores pioneiros em levar os alunos para o Cemitério Local, para ter aula de filosofia e mostrar a fragilidade do corpo humano. Também, fantasiado de mendigo deu aulas práticas em um shopping com objetivo de fazer os jovens alunos refletirem sobre o preconceito. Anselmo também compôs uma dezena de músicas. Na voz do juiz sanfoneiro, Ednaldo Fonseca, teve gravada Saudades de Luiz Gonzaga. Já o cantor e sanfoneiroTargino Gondim, gravou a música Na Sombra do Juazeiro, forró que recebeu elogios do mestre Dominguinhos, durante as festividades de nascimento de Luiz Gonzaga, numa das festas em Exu, Pernambuco."
		},
		{
		...
		},
		{
		    ...
		    content: "Faleceu por volta das 23:00 horas de ontem, segunda-feira (24), no hospital do traumas em Petrolina, o maior craque de futebol de todos os tempos no Vale do São Francisco. Gilmar Santos morreu aos 63 anos de idade, por conta de complicações respiratórias, o mesmo já vinha há algum tempo enfrentando graves problemas de saúde. O corpo de Gilmar Santos está sendo velado em sua residência no Centro de Santa Maria da Boa Vista, que fica localizada em frente ao Banco do Brasil. Gilmar deixa esposa, filhos e netos.  O sepultamento será as 16:00 horas de hoje, no cemitério da cidade de Santa Maria da Boa Vista. Gilmar Santos é natural da cidade de Paulo Afonso, região Norte do Estado da Bahia. Em Pernambuco Gilmar fez historia nos campos de futebol jogando por varias equipes, com talento inigualável e com jogadas espetaculares o mesmo se tornou uma lenda vida do futebol sertanejo. Gilmar defendeu grandes equipes de 1980, entre elas o famoso America de Petrolina e a própria seleção da principal cidade do sertão. No radio Gilmar também foi incomparável, foi um dos primeiros locutores nas transmissões da radio Boa Vista FM. Gilmar Santos, foi comentarista e narrador esportivo. Outra marca de Gilmar Santos, foi na seleção boavistana de futebol, quando o mesmo colocou seu talento a serviço do futebol local na condição de Técnico da Seleção de Futebol de Santa Maria da Boa Vista."
		},
		{
		    title: "Morre ex-primeira dama de Petrolina Mariana Cavalcanti Diniz, esposa de Seu Diniz",
		    content: "A ex-primeira dama de Petrolina Mariana de Jesus Reis Cavalcanti faleceu na manhã desta terça-feira (08). Dona Mariana era esposa do ex-prefeito do município Diniz Cavalcanti conhecido como “Seu Diniz”, e faleceu de causas naturais."
		},
		{
	...
	visitas: {
		...
		{
		    title: "Visita de Temer ao Estado",
		    content: "O Presidente da República Michel Temer, foi recebido pelo Prefeito de Petrolina-PE, Miguel Coelho, nesta sexta-feira(23). O encontro aconteceu no Aeroporto Nilo Coelho."
		}
	    ]
	},
	resumo: {
	...
	obituario: {
	    ...
	    content: [
		{
		    title: "Benedito Lacerda da cidade de Santa Maria da Boa Vista",
		    content: "Morreu agora a pouco na cidade de Petrolina o vereador Benedito Lacerda da cidade de Santa Maria da Boa Vista, o mesmo estava internado no HGU daquela cidade já há alguns dias devido complicações respiratórias. A morte de Benedito Lacerda foi confirmada agora mesmo por dirigentes do PMDB de Santa Maria da Boa Vista, partido o qual Benedito é filiado desde seus primeiros envolvimentos na política local. Benedito Lacerda estava com 49 anos de idade, casado e é pai de três filhos. O mesmo é comerciante do ramo de funerária no município de Santa Maria da Boa Vista, iniciou sua participação em política ainda jovem nos anos de 1982. Benedito Lacerda está no segundo mandato de vereador, atualmente o mesmo era o vice presidente do PMDB de Santa Maria da Boa Vista."
		}
	    ]
	},
	inauguracoes: {
	    ...
	    content: [
		{
		    title: "Centro de Atendimento do Bolsa-Família",
		    content: "O prefeito Miguel Coelho inaugura, nesta sexta-feira (24/03), a Casa Bolsa. O equipamento será o novo centro para atender todas as demandas dos mais de 30 mil beneficiários do programa Bolsa Família em Petrolina. O evento ocorre, às 10h, na Avenida Tancredo Neves, Centro. Atualmente, o atendimento do Bolsa-Família é feito na sede da Secretaria de Desenvolvimento Social. Toda a estrutura e funcionários do antigo equipamento destinados a este serviço social serão realocados para a Casa Bolsa. No novo espaço, os beneficiários terão mais conforto e acessibilidade. Além de estar situado próximo a bancos, fórum, cartórios, cinema e lojas, a Casa Bolsa contará com um ambiente climatizado, brinquedoteca, mobília e equipamentos para assegurar o bem estar das pessoas durante o  tempo de espera. O horário de funcionamento aos beneficiários do Bolsa Família no novo equipamento continuará  das 8h às 13h. Contudo, a Prefeitura já planeja estender o serviço na Casa Bolsa para o horário da tarde."
		},
		{
		    title: "Policlínica de Petrolina",
	...
	atracoes: {
		...
		{
		    title: "Carnaval",
		    content: "Faltando cinco dias para o início do Carnaval em Petrolina, no Sertão de Pernambuco, a programação oficial dos festejos de 2016. A folia na cidade acontece entre os dias 6 e 9 de fevereiro no polo principal, Praça 21 de Setembro/Orla, e nos bairros Areia Branca, Cohab VI e Rio Corrente. Entre as atrações previstas estão cantores e bandas da região, orquestras e fanfarras. No primeiro dia da festa, o sábado (6), subirão ao palco montado na Avenida Cardoso de Sá, o grupo Axé Camaleão e o cantor Alan Cléber. No domingo (7) a folia será animada pela cantora Fabiana Santiago e pela banda Miragem. O dia 8 terá as apresentações do grupo Nosso Harém e de Elisson Castro & Banda Pega Leve. No último dia do Carnaval de Petrolina, a terça-feira (9), os shows serão de Alan Cléber, Ana Costa e Voa Voa. Integram também a programação oficial, a abertura com o cortejo de afoxé e as apresentações das orquestras Fernando Júnior, Joãozinho Maravilha, Skalla e Frevart. Nos bairros, a programação e os dias de festa serão acertados com as associações de moradores. Segundo a assessoria de comunicação da prefeitura, a programação foi montada para valorizar a cultura pernambucana e dar espaço aos artistas locais."
		},
		{
		    title: "São João",
		    content: "Foram divulgadas nesta terça-feira (19), as atrações do São João de Petrolina, no Sertão de Pernambuco. A festa no Pátio de Eventos Ana das Carrancas será realizada entre os dias 17 e 25 de junho. Este ano, o evento será em homenagem ao ex-deputado Osvaldo Coelho. Entre as principais atrações estão, Wesley Safadão, Aviões do Forró, Henrique e Juliano, Fernando e Sorocaba, Burno e Marrone, Raimundinho do Acordeon e As Coleguinhas. O início dos festejos juninos começam com a 30ª  Vaquejada de Petrolina, no Parque Dr. Geraldo Estrelas, que acontece entre os dias 2 e 5 de junho. Entre as atrações estão Alcimar Monteiro, Mano Walter, Sirano e Sirino, Leno e Pega Leve. A festa será aberta ao público. No dia 12 será realizada a tradicional Jecana do Capim. No dia 13 acontece o Festival de Violeiros, dia 14 será a Noite Cultural, dia 15 o Concurso de Sanfoneiros e dia 16 o Concurso de Quadrilhas. Já festa no Pátio de Eventos Ana das Carrancas, localizado na Zona Norte da cidade, acontece entre os dias 17 a 25 de junho. O prefeito de Petrolina, Julio Lossio, disse que apesar do momento crítico da economia brasileira, será possível fazer uma grande festa."
		},
		{
		    title: "Festa na Orla",
		    content: "Em Petrolina, no Sertão de Pernambuco, vai ter festa para todos os gostos durante a virada de ano. Além da tradicional festa pública na Porta do Rio que fica na Orla, serão realizados ainda eventos particulares em bares, restaurantes e clubes da cidade. A festa de réveillon do Iate Clube já tá sendo preparada. E esse ano são esperadas cerca de 500 pessoas. “Para comemorar o cinquentenário do Iate Clube, nós pensamos em iniciar o ano com réveillon e terminando com o carnaval com muita festa e muita folia”, comenta o diretor do Iate Clube de Petrolina, Jorge Assunção."
		}
	    ]
	},
	obituario: {
	...
	inauguracoes: {
		...
		{
		    title: "Iluminação expandida no Parque Massangano",
	...
	atracoes: {
	    ...
	    content: [
		{
		    title: "São João do Vale",
		    content: "Depois de muita especulação, foi divulgada nesta segunda-feira (25) a programação oficial do São João do Vale 2015 em Petrolina, no Sertão de Pernambuco. Este ano a festa acontece entre os dias 23 e 27 de junho no Pátio de Eventos Ana das Carrancas, no bairro Cosme e Damião, na Zona Norte, e reúne tanto atrações locais quanto nacionais, como a dupla sertaneja Bruno e Marrone e o cantor Gusttavo Lima. Segundo a assessoria da prefeitura, a proposta desta edição é a diversidade, por isso a programação atende a vários estilos musicais, entre eles o sertanejo universitário, o arrocha e o tradicional forró. As comemorações do período junino já começam na próxima semana, de 4 a 7 de junho, com a realização da vaquejada. Nos dias 12, 13 e 14 do mesmo mês é a vez da Jecana, uma competição de jumentos realizada no povoado do Capim, na Zona Rural do município. Este ano a homenagem será ao seu idealizador, o radialista Carlos Augusto, que faleceu no último dia 2 de abril. Nos dias 19 e 20 de junho acontece na Concha Acústica, no Centro da cidade, o São João Cultural, com apresentações juninas e o festival de violeiros e sanfoneiros. Encerrando a programação no dia 28, acontece a missa do vaqueiro."
		},
		{
		    title: "Réveillon",
	...
	obituario: {
	    ...
	    content: [
		{
		    title: "Professor do IF Sertão de Petrolina morreu agora a pouco em um acidente de transito",
		    content: "Um grave acidente agora a pouco na altura da entrada do N-4, Projeto de Irrigação Senador Nilo Coelho, BR 235, Município de Petrolina, Sertão do São Francisco, mata o Professor do IF Sertão, Campus Petrolina, Alexandre Ferreira. O corpo do mesmo ficou em estado irreconhecível devido à forte pancada, o Professor que costumeiramente viajava de moto para o local de trabalho no Campus do IF próximo ao local do acidente, teria colidido de frente com um veiculo VAN de transportes de passageiros. Segundo populares que chegaram logo após o acidente choque, o corpo do Professor ficou completamente irreconhecível."
		},
		{
		    title: "Petrolina em luto! Morre o Pe. Bernardino",
		    content: "Faleceu hoje (16.01) o Pe Bernardino Padilha da Luz, o mesmo completaria 90 anos  em setembro de 2015. Segundo sua irmã a senhora Margarida Padilha ele enfrentava vários problemas de saúde como pneumonia e parckinson. O religioso veio a óbito em uma UTI na cidade de Juazeiro-BA. Pe Bernadino nasceu em 12 de setembro de 1925 no município de Petrolina, tornou-se conhecido em toda a região por causa de um momento de oração pela manhã na Rádio Emissora Rural, o qual até hoje foi retransmitido. Ele era muito querido na cidade de Petrolina. Enquanto ainda exercia o sacerdócio rezava missa as 17hs para as crianças. No último dezembro foi celebrada em sua homenagem uma missa pelo aniversário de 60 anos de sacerdócio, da qual o mesmo não participou já em função de sua saúde frágil. Ele chegou a receber o título de monsenhor, uma honra conferida pelo papa a clérigos católicos. Ainda não foi decidido onde serão oferecidas as últimas homenagens ao religioso. Em breve novas informações."
		},
		{
		    title: "População de Petrolina e região comparecem ao velório de Seu Odair, pai do deputado estadual Odacy Amorim",
		    content: "Grandes filas foram formadas desde o final da manhã desta segunda-feira, 19, por gente de toda a região do interior de Petrolina, no sertão pernambucano, e de cidades vizinhas, na casa do agricultor Odair Granja de Souza, em Rajada (distrito de Petrolina), pai do deputado estadual Odacy Amorim (PT-PE). Todos foram dá um último adeus ao agricultor que era bastante querido por todos e levar um abraço ao deputado. Seu Odair morreu na noite deste domingo, 18, vítima de acidente de carro quando estava próximo à Rajada. Odacy esteve durante todo o momento presente no velório, dando atenção a todos que foram levar uma palavra de conforto ao deputado e seus familiares pela perda inesperada. O deputado também se manteve firme para dá força à mãe, Isabel Amorim de Souza ou Dona Menininha como é carinhosamente chamada por todos, e aos irmãos Odomy, Odair, Miranery e Joana Amorim, além de demais familiares e parentes.  Dona Menininha estava também no veículo que vitimou Seu Odair, mas sofreu apenas alguns ferimentos, mesmo tendo ficado presa às ferragens. Outras duas pessoas que também vinham no carro, não correm risco de morte. Além da população em geral, o deputado Odacy Amorim recebeu o abraço de várias autoridades como prefeitos e ex-prefeitos da região, deputados como o colega de Assembleia Legislativa, Adalberto Cavalcante (PTB); vereadores e ex-vereadores, entre muitos amigos que tem dentro e fora da vida pública. O prefeito de Petrolina, Júlio Lóssio (PMDB), disse que fez questão de comparecer ao velório do pai do deputado Odacy Amorim. Júlio esteve em Rajada acompanhado de alguns secretários municipais, assessores e do vereador e líder do governo na Câmara Municipal, Elismar Gonçalves (PMDB)."
		}
	    ]
	},
	inauguracoes: {
	    ...
	    content: [
		{
		    title: "Centro Cultural Emoções",
		    content: "No dia 19 de abril, data em que Roberto Carlos comemorou 74 anos, foi inaugurado em Petrolina, Pernambuco, um Centro Cultural que homenageia o cantor. Criado pelo fã e colecionador Adriano Thales, com o apoio de uma empresária paulista(que prefere manter-se no anonimato), o local mostra, através de mais de 500 peças, entre fotos, pôsteres, discos, CDs, vídeos, fitas e revistas, a rica carreira do rei ao longo de mais de 50 anos. Além disso, O Centro Cultural Emoções também vai desenvolver um trabalho carente com crianças da cidade. O espaço conta com três salas: a recepção, a sala de áudio e vídeo e a sala de música, onde crianças carentes aprenderão a tocar um instrumento musical. Existe ainda o salão grande onde está exposto o acervo. Segundo o vice-presidente, João Francisco, provavelmente ainda neste mês de maio o Centro Cultural já estará aberto para visitação. \"Já temos, inclusive, solicitação de outros estados, para visitação do espaço através de equipes de turismo. Mas ainda estamos dependendo da liberação do alvará de funcionamento a ser expedido pela Prefeitura Municipal de Petrolina. Informaremos quando as atividades começarem de fato.\", completa."
		},
		{
		    title: "Prefeitura inaugura Clube do Bairro da Vila 12",
		    content: "A Prefeitura de Petrolina  inaugura na próxima segunda – feira, 16, às 18h30, um novo Clube do Bairro. Instalado na Vila Aparecida – Vila 12,  PSNC (Projeto senador Nilo Coelho ), a praça é a 3ª que será entregue à população dos núcleos irrigados. Ao todo serão entregues 16 Clubes. Sob a responsabilidade da Secretaria de Infraestrutura, os Clubes do Bairro incentivam a população à pratica de esporte. Além de proporcionar  lazer, qualidade de vida e mais saúde para comunidade. “Estamos oferecendo mais saúde e lazer à população. Esse é um compromisso da nossa gestão”, comentou o prefeito, Julio Lossio. Em cada um dos espaços são colocados à disposição dos moradores 5 tipos de equipamentos de ginástica, pista de caminhada, mesas para xadrez, brinquedos como escorregador, balanço e carrossel,  poste de iluminação própria e totem de identificação com a logomarca Clube do Bairro, além do plantio de 8 árvores e calçada com piso em intertravado. O espaço tem uma área total de 1.000 metros quadrados e conta com investimento de R$ 76.792,58 (Setenta e Seis mil setecentos e e noventa e dois reais e cinquenta e oito centavos). A empresa responsável pela obra é a Sete Construções Ltda e o tempo de execução é de 4 meses."
		},
		{
		    title: "Prefeitura de petrolina inaugura sede da guarda municipal e celebra o aniversário da corporação",
	...
	atracoes: {
		...
		{
		    title: "Carnaval",
		    content: "As atrações do carnaval 2014 de Petrolina, no Sertão pernambucano estão confirmadas pela Prefeitura do município. A festa acontece no polo Orla entre os dias 26 de fevereiro a 4 de março e tem como tema “Folia no Vale dos Vinhos – De frevo a bola tudo rola”. Na Porta do Rio, será montado o palco que receberá as principais atrações como os petrolinenses Geraldo Azevedo e Zé Manoel, que acaba de retornar de uma turnê pela Europa. Mas artistas locais como a cantora Camila Yasmine e as banda Pega Leve e Nosso Harém também se apresentam no evento. A programação ainda conta com os tradicionais blocos carnavalescos com orquestras de frevo e cortejos, que saem da Praça Dom Malan, no centro, chegando à orla da cidade. A festa é um realização da prefeitura com o governo estadual através da Fundação do Patrimônio Histórico e Artístico de Pernambuco (Fundarpe). Os shows musicais no palco da Orla devem começar a partir das 20h."
		},
		{
		    title: "Jecana",
		    content: "Nesta quarta-feira (28), a Prefeitura de Petrolina, Sertão pernambucano, comunicou em nota a realização da 43ª edição da Jecana, corrida de burros e jegues da cidade em nova data. Anteriormente o idealizador do evento declarou ao G1 que a festa poderia não acontecer porque o valor oferecido pela prefeitura era insuficiente para a realização do evento. De acordo com o radialista Carlos Augusto, a prefeitura teria oferecido inicialmente R$ 150 mil para edição 2014 em infraestrutura. Mas as premiações e outros gastos deveriam ser pagos com verba de patrocínio, o que, segundo o idealizador da Jecana será inviável dada a proximidade do evento, que estava previsto para os dias 6 a 8 de junho. Segundo a nota, foi firmado um acordo com o organizador do evento e a nova data da festa é de 13 a 15 de junho, na comunidade do Capim, Zona Rural de Petrolina. Para o evento acontecer, além do valor de R$ 150 mil, reservado para arcar com a estrutura da festa, outras despesas também serão cobertas pela gestão municipal. Foi divulgada ainda a primeira atração do evento, o cantor Maciel Melo. A organização estima um público de mais de 30 mil pessoas na Jecana durante os três dias de realização."
		},
		{
		    title: "São João",
	...
	inauguracoes: {
	    ...
	    content: [
		{
		    title: "RedeVASF é inaugurada durante cerimônia em Petrolina",
	...
	atracoes: {
		...
		{
		    title: "São João do Vale",
		    content: "Inspirado na citação “O sertanejo é, antes de tudo, um forte”, do escritor Euclides da Cunha, o São João de Petrolina, no Sertão de Pernambuco, ocorre entre os dias 15 e 30 de junho. A programação da festa, intitulada \"São João do Vale\", foi divulgada na tarde de segunda (10) pelo prefeito Júlio Lóssio. A abertura será com a tradicional Jecana – corridas, desfiles de jegues e apresentações musicais – no dia 15 de junho, na comunidade do Capim. Entre os dias 17 e 19, o município vai contar com atividades culturais na Concha Acústica, onde sanfoneiros e violeiros regionais se apresentarão com o melhor da cultura nordestina desta época do ano. No dia 23, às 10h, o Rio São Francisco vai receber o Forró das Águas, uma festa à beira do rio."
		},
		{
		    title: "Show Pirotécnico - Réveillon na orla",
		    content: "O réveillon em Petrolina, Sertão Pernambucano, terá show pirotécnico de 15 minutos, com shows musicais começando às 21h na Orla da cidade. São quatro atrações: o cantor Alan Cleber, as duplas sertanejas Ytalo e Maciel e Edson e Bruno e a banda de pagode Nosso Harém. “Estamos prestigiando bandas regionais e iniciaremos a festa pontualmente as 21h com Alan Cleber, para que crianças e idosos que não ficam até tarde, possam aproveitar a festa também”"
		}
	    ]
	},
	obituario: {
	    ...
	    content: [
		{
		    title: "Morre aos 91 anos de idade seu Luiz Novaes",
		    content: "Morreu hoje cedo no hospital do neoro-cárdio na cidade de Petrolina o mais conhecido torcedor do arruda seu Luiz Novaes. Luiz Novaes morreu aos 91 anos de idade, há algum tempo já estava bastante debilitado, devido problema de saude. Luiz Novaes conhecido em Cabrobó como o engenheiro das grandes obras, escreveu seu nome nas placas e inaugurações das mais importantes obras da cidade, entre elas, a quadra de esportes “O Araújão”, construída nos anos 70, sendo na época considerado um dos mais importantes ginásios esportivos do estado, Luiz Novaes ainda contribuiu com a construção do estádio de futebol, em fim a historia de Luiz Novaes, o tempo se encarregará de contar."
		}
	    ]
	},
	inauguracoes: {
	...
	atracoes: {
	    ...
	    content: [
		{
		    title: "São João do Vale 2012",
		    content: "As atrações do São João do Vale 2012 da cidade de Petrolina foram anunciadas na última terça-feira (13) pela Prefeitura do Município, em festa de pré-lançamento na Casa de Eventos Manga Rosa, no centro da cidade. Serão 15 dias de festas com artistas de cunho regional e nacional, como Paula Fernandes, Gustavo Lima e Victor e Léo. Este ano o evento homenageará o centenário de Luiz Gonzaga, buscando reunir um maior número de pessoas e impulsionar a economia, cultura e turismo de Petrolina."
		},
		{
		    title: "Jecana 2012",
		    content: "Nos dias 08, 09 e 10 de junho, haverá em Petrolina a tradicional Jecana ou “corrida de jegues”. A festa é uma idealização do radialista Carlos Augusto, e acontece na comunidade de Capim, localizada a cerca de 30 Km do Centro de Petrolina. Neste ano, a festividade conta com o apoio da prefeitura do município para sua realização. Para o organizador Carlos Augusto, a parceria é de grande importância para execução da Jecana. “O apoio da prefeitura é indispensável para a Jecana. Essa atitude do prefeito Julio Lossio nos dá condições para realizar esse evento tradicional na cidade”. A Jecana já acontece há mais de 40 anos em Petrolina, juntamente com os festejos juninos. A festa envolve público de classes sociais diferentes com o objetivo de manter vivo um dos principais símbolos do sertão: o jumento ou jegue, além de incentivar a preservação do animal na região. No ano passado, o evento contou com mais 20 mil pessoas."
		},
		{
		    title: "Vale dos Vinhos – Carnaval 2012",
		    content: "Para homenagear a vocação econômica da região do Vale do São Francisco e valorizar a cultura da festa de Momo, este ano o carnaval de Petrolina terá como tema: “Folia no Vale dos Vinhos: Fantasias de Carnaval no Vale”. Com atrações regionais e nacionais o carnaval promete levar famílias inteiras para as ruas da cidade e integrar toda a comunidade. De acordo com informações das Secretarias de Cultura e de Desenvolvimento Econômico, Turismo e Eventos do Município, várias atividades foram programadas para os dias de festa com destaque para as Oficinas de Frevo que acontecem desde esta segunda-feira (13) e vão até dia 17, o Concurso de Fantasias, o Bloco Nova Semente, além das Orquestras de Frevo, Blocos de Rua e as atrações regionais e nacionais nos pólos do centro, localizados na Praça 21 de setembro e na Orla."
		}
	    ]
	},
	obituario: {
	...
	inauguracoes: {
	    ...
	    content: [
		{
		    title: "Integração Nacional inaugura museu de fauna, em Petrolina (PE)",
		    content: "Com investimentos de mais de R$ 900 mil, o Ministério da Integração Nacional inaugura nesta sexta-feira (29/06), às 9h, o Museu de Fauna da Caatinga, no Campus de Ciências Agrárias da Universidade Federal do Vale do São Francisco (Univasf), em Petrolina (PE). A unidade faz parte do Centro de Conservação e Manejo de Fauna da Caatinga (Cemafauna) e tem como objetivo abrigar as coleções científicas de animais resgatados na área de abrangência do Projeto de Integração do Rio São Francisco e de outras localidades. Com 815 m², o espaço também terá a missão de agregar conhecimento técnico e científico, promovendo ações de educação ambiental e de cidadania voltadas para as comunidades de ensino, nacionais e estrangeiras, e para a sociedade em geral. O Museu conta uma sala de geoprocessamento responsável por concentrar os dados resultantes das atividades de resgate e monitoramento dos diversos grupos de animais encontrados. O objetivo é realizar o mapeamento das espécies nas áreas afetadas direta e indiretamente pelo Projeto de Integração do Rio São Francisco."
		},
		{
		    title: "Prefeitura inaugura monumento à Bíblia em Petrolina",
		    content: "Está marcado para 18h desta sexta-feira (25/5) a solenidade de inauguração do Monumento à Bíblia construído pela Prefeitura Municipal de Petrolina. O novo monumento fica situado no cruzamento da Avenida Clementino Coelho com a Avenida da Integração, nas proximidades do Templo da Igreja Batista Missionária Central no bairro Palhinhas. O monumento foi uma idéia do prefeito Julio Lossio e foi concebido por um artista plástico contratado pela prefeitura."
		},
		{
		    title: "AME Saúde da Família",
		    content: "A Prefeitura Municipal de Petrolina inaugura na noite desta sexta-feira (05), a partir das 20h, mais uma unidade de Atendimento Multiprofissional Especializado (AME – Saúde da Família) da cidade. A unidade que será aberta hoje à noite no bairro Henrique Leite é a quinta AME de Petrolina e, além de atender os moradores da comunidade onde está instalada, também prestará serviços para os moradores do Loteamento Geovana, Ilha Jatobá, bairro Carneiro, Vila Vitória, Idalino Bezerra, Parque Jatobá I e II, Rio Jordão e Novo Horizonte."
		},
		{
		    title: "MPT inaugura novo prédio em Petrolina com a presença da ANPT",
	...
	atracoes: {
		...
		{
		    title: "São João 2011",
		    content: "Foi divulgado nesta sexta-feira (06) pela rádio Grande Rio FM, a programação completa do São João 2011 do município de Petrolina. De acordo com a mencionada rádio os festejos juninos de Petrolina ocorrerão de 22 a 30 de junho com diversas atrações de renome nacional e regional. A programação conta com artistas famosos em todo o Brasil como Jorge e Mateus, Elba Ramalho, Maria Cecília e Rodolfo e Beto Barbosa, bem como de bandas conhecidas em todo Norte e Nordeste, a exemplo de Gatinha Manhosa, Brasas do Forró, Noda de Cajú, Ranieri e Banda, Os 3 do Cariri e Gaviões do Forró. O São de João de Petrolina ainda contará com shows de Banda Magníficos, Leo e Leno e Forró 3 Desejos, Tayrone Cigano, Desejo de Menina, entre outras atrações."
		},
		{
		    title: "7ª Festa do Bode",
		    content: "A 7ª Festa do Bode – Feira de Caprinos e Ovinos no povoado de atalho, zona rural de Petrolina – será realizada até hoje (11). Nesta edição, aberta no sábado (10), o foco principal continua sendo a melhoria genética do rebanho do interior de Petrolina para Produção de Carne de Cordeiro e Cabrito, Leite e Derivados de Leite de Cabra. Está sendo apresentado o que há de melhor entre as variedades de animais que são produzidos na região.A programação conta ainda com shows de Raimundinho do Acordeon e Mundinho da Rajada. A festa promete movimentar todo fim de semana no povoado de Atalho, localizado a pouco mais de 80 km de Petrolina. São esperados mais de 1.500 visitantes permanentes e temporários durante a mostra."
		}
	    ]
	},
	obituario: {
	...
	inauguracoes: {
	    ...
	    content: [
		{
		    title: "Inauguração do Colégio Militar de Petrolina",
		    content: "inauguração do Colégio Militar de Petrolina. O governador Eduardo Campos e o Ministro da Integração Nacional Fernando Bezerra Coelho (ambos PSB) estão presentes. Os deputados federais Fernando filho e Gonzaga Patriota (ambos PSB) e os estaduais Odacy Amorim (PSB) e Adalberto Cavalcanti (PHS) também acompanham a comitiva. Os suplentes de deputados Ciro Coelho (PSB) e Isabel Cristina (PT) foram convidados e estão no dispositivo de honra. Vários secretários estaduais, o prefeito de Petrolina (PMDB) Júlio Lóssio e prefeitos regionais também estão aqui."
		}
	    ]
	},
	personalidades: {
	...
	atracoes: {
	    ...
	    content: [
		{
		    title: "Divulgada programação oficial do São João 2010 de Petrolina",
		    content: "A Secretaria de Desenvolvimento Econômico, Turismo e Eventos de Petrolina transformou o São João da cidade em um dos maiores pólos juninos de Pernambuco. Além dos 143 dias de festas em 45 bairros, a partir do dia 23 de junho, a orla fluvial será o palco oficial dos festejos. Serão quatro dias de festa as margens do Rio São Francisco. A abertura acontece no dia 23 de junho com o cantor Tayrone Cigano e as bandas Cavalo de Pau e Rosa Xote. Além destas atrações, já estão confirmadas as bandas Desejo de Menina, Forrozão Chacal, Léo e Leno"
		},
		{
		    title: "Fenagri",
		    content: "Já está tudo pronto para a abertura da XXI Feira Nacional da Agricultura Irrigada – FENAGRI 2010, que acontecerá de 28 a 31, no Centro de Convenções em Petrolina. O prefeito Júlio Lóssio, fará hoje (28) às 19h, na entrada da Feira, a abertura oficial do evento. Toda a estrutura de 350 estandes foi comercializada e está pronta para receber expositores, produtores, instituições de pesquisa e de difusão tecnológica e a imprensa de todo o Brasil. A Fenagri, que é considerada a maior feira de fruticultura irrigada da América Latina, tem como slogan este ano “Os frutos dos novos negócios”, que para o coordenador da Feira, Pedro Tasso, representa um novo tempo. “Atingimos uma maturidade importantíssima para o agronegócio frutícola do Vale. Somos reconhecidos mundialmente pelo compromisso com que trabalhamos e desenvolvemos a nossa agricultura. A Fenagri vem para abrilhantar tudo isso. Podem esperar, pois este ano, faremos a feira das feiras”."
		}
	    ]
	},
	obituario: {
	...
	inauguracoes: {
	    ...
	    content: [
		{
		    title: "NCUBAVALE é inaugurada em Petrolina/PE",
		    content: "Nesta quinta-feira (26), o secretário de Ciência, Tecnologia e Meio Ambiente, Anderson Gomes, e o presidente do Instituto de Tecnologia de Pernambuco (Itep), Frederico Montenegro, inauguraram, em Petrolina/PE, a nova incubadora de base tecnológica do Estado. Trata-se da Incubavale – Incubadora de Empresas de Base Tecnológica do Vale do São Francisco -, que vai funcionar nas dependências da Faculdade de Ciências Sociais e Aplicadas de Petrolina (Facape). A inauguração da Incubavale aconteceu na sede da Facape, logo após as primeiras palestras do Workshop de Capacitação em Empreendedorismo, Inovação e Incubação de Empresas do Vale do São Francisco, que aconteceu no auditório do Senai, de quinta (26) a sábado (28). A abertura do workshop contou com a presença de empresários, estudantes e potenciais empreendedores daquela região. A nova incubadora será um ambiente de estímulo ao empreendedorismo da região, apoiando idéias inovadoras e empresas nascentes que visem a contribuir na solução dos gargalos tecnológicos e de ausências de empresas em determinadas áreas necessárias ao desenvolvimento da região, conforme explicou o presidente do Itep, Frederico Montenegro. A Incubavale é uma iniciativa do Itep, por meio da Incubatep, com o apoio de diversas instituições do Vale do São Francisco. A nova incubadora, na Facape, uma importante parceira do Itep na iniciativa, tem capacidade para abrigar seis empresas incubadas. A coordenação local será do professor José Paulo Fagundes."
		}
	    ]
	},
	estatisticas: {
	...
	atracoes: {
	    ...
	    content: [
		{
		    title: "Prefeito de Petrolina lança programação do São João 2009 nesta quarta",
		    content: "O prefeito de Petrolina, Júlio Lóssio, fará abertura oficial do São João 2009 nesta quarta-feira (10) às 19 horas, no espaço Mandala, no Bodódromo. Na oportunidade, serão divulgadas as atrações da programação oficial, além de uma apresentação com os artistas Alan Cleber e Camila Yasmin, que farão a animação com músicas juninas. A prefeitura ainda vive a expectativa de ser pólo junino, garantindo assim o patrocínio do Governo do Estado. Lóssio, no entanto, garante que fará a festa, de um modo ou de outro."
		},
		{
		    title: "Festa do Vaqueiro torna-se Patrimônio de Pernambuco",
		    content: "Um dos maiores espetáculos do calendário turístico de Pernambuco, a Festa do Vaqueiro, realizada anualmente em Serrita, no Sertão do Estado, é, agora, Patrimônio Cultural Imaterial de Pernambuco. A iniciativa da concessão do título partiu de proposta do deputado Maviael Cavalcanti (DEM). O parlamentar apresentou o Projeto de Lei n° 933/09, que originou a Lei n° 13.746/2009. A Festa do Vaqueiro é um evento religioso que se originou após o assassinato do vaqueiro Raimundo Jacó. Em junho de 1954, ele foi encontrado morto com uma pancada na cabeça no Sítio Lages, distrito da mesma localidade. Segundo a lenda, Raimundo Jacó era um vaqueiro capaz de adivinhar onde bebia e comia cada cabeça de gado de sua responsabilidade. Sendo assim, criou-se um mito em torno do sertanejo assassinado, sendo consagrado como modelo do vaqueiro, símbolo de dedicação e coragem. O espírito místico do povo da região transformou o lugar do crime em local sagrado, passando a ser motivo de constantes romarias."
		},
		{
		    title: "Bodódromo vira grande arraial no São João de Petrolina",
		    content: "Com o slogan \"Festa em Todo Lugar\", a prefeitura de Petrolina lançou oficialmente nesta quarta, para a imprensa, funcionários e parceiros, a programação oficial do São João, que este ano terá shows e apresentações culturais concentrados em um dos mais importantes equipamentos turísticos do município: o Bodódromo, no bairro de Areia Branca. A festa acontece entre os dias 22 e 28 de junho e deve receber no palco principal, nomes como Jorge de Altinho, Assisão, Nando Cordel, Flávio Leandro, Geraldinho Lins, Amelinha, dentre outros."
		}
	    ]
	},
	obituario: {
	...
	inauguracoes: {
	    ...
	    content: [
		{
		    title: "Galeria de Artes Ana das Carrancas",
		    content: "A Galeria de Artes Ana das Carrancas foi inaugurada em 2009. O espaço tem capacidade para 100 pessoas e funciona de terça a sexta das 8h as 20h e sábado e domingo das 16h às 20h com atendimento ao público em geral e mediação educativa para escolas públicas. A Galeria de Artes Ana das Carrancas foi inaugurada em 2009. O espaço tem capacidade para 100 pessoas e funciona de terça a sexta das 8h as 20h e sábado e domingo das 16h às 20h com atendimento ao público em geral e mediação educativa para escolas públicas. O nome da galeria é uma homenagem à artesã Ana Leopoldina dos Santos, mais conhecida como Ana das Carrancas ou a Dama do Barro. Pernambucana de Ouricuri, que fez do barro o seu instrumento de trabalho e de expressão artística. Em 2006, Ana das Carrancas recebe o título de Patrimônio Vivo de Pernambuco. Dois anos mais tarde, vem a falecer aos 85 anos."
		}
	    ]
	},
	personalidades: {
